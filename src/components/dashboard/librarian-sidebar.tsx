...
import { schoolInfo, librarianUser } from "@/lib/demo-data";
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="px-6 py-3">
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#10B981]/10">
              ...
              <span className="text-[12px] font-semibold text-[#10B981]">Library Dashboard</span>
            </div>
          </div>
          ...
          <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
            ...
            {navigation.map((item) => {
              const isActive = item.href === "/librarian"
                ? pathname === item.href
          ...
          <div className="p-4 border-t border-[var(--border)]">
            <div className="flex items-center gap-3 p-3 rounded-lg bg-[var(--background-secondary)]">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#10B981] to-[#059669] flex items-center justify-center text-white font-semibold text-sm">
                {librarianUser.firstName[0]}{librarianUser.lastName[0]}
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-[var(--foreground)] truncate">
                  {librarianUser.firstName} {librarianUser.lastName}
                </p>
