 ...
 * Includes navigation links, user info, and school branding
 */
...
export function DashboardSidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside data-tour-id="sidebar" className={`
      ...
      `}>
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
            ...
            {navigation.map((item) => {
              const isActive = item.href === "/school-admin"
                ? pathname === item.href
                ...
                >
                  ...
                  {item.badge && (
                    <span className={`
                      ...
                      ${isActive ? "bg-white/20 text-white" : "bg-[#0891B2]/10 text-[#0891B2]"}
                    `}>
                      {item.badge}
                    </span>
                  )}
          ...
          <div className="p-4 border-t border-[var(--border)]">
            <div className="flex items-center gap-3 p-3 rounded-lg bg-[var(--background-secondary)]">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#0891B2] to-[#10B981] flex items-center justify-center text-white font-semibold text-sm">
