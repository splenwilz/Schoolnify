    ...
    >
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-[var(--foreground)]">Report Cards</h1>
            <p className="text-[13px] text-[var(--muted)] mt-0.5">Generate, manage, and publish student report cards</p>
          </div>
        </div>
